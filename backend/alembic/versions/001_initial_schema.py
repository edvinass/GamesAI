...
def upgrade() -> None:
    room_status = sa.Enum("lobby", "playing", "finished", name="room_status")
    team = sa.Enum("red", "blue", name="team")
    role = sa.Enum("spymaster", "operative", name="role")
    ...
    op.create_table(
        ...
        sa.Column("team", team, nullable=True),
