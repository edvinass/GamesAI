...
import type { BoardState, GameRules, KataGoBackendPreference, Move, Player, RegionOfInterest } from '../katagoTypes';
...
async function warmupModel(candidate: KataGoModelV8Tf): Promise<void> {
  const spatial = tf.zeros([1, BOARD_SIZE, BOARD_SIZE, 22], 'float32') as tf.Tensor4D;
