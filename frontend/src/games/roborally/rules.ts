...
export const roborallyRules: GameRules = {
  ...
  quickStart: [
    ...
    'Cards resolve by printed priority (higher first). Robots push.',
    'After each register: express belts → all belts → pushers → gears → crushers → lasers → checkpoints.',
    'Visit checkpoints in order. First to finish wins. Fall in a pit or take 10 damage and you reboot next turn.',
  ],
  sections: [
    {
      heading: 'Programming',
      ...
      bullets: [
        ...
        'Turn Left / Right / U-Turn rotate in place; Backup steps backward.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Checkpoints count at end of a register. Repair/upgrade sites heal at end of the turn.',
      ],
    },
    {
      heading: 'Winning',
